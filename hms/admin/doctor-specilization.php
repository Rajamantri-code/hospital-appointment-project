...
{
	$sql1 = "insert into doctorSpecilization(specilization) values('".$_POST['doctorspecilization']."')";
...
if(isset($_GET['del']))
		  {
			$sql = "delete from doctorSpecilization where id = '".$_GET['id']."'";
		          mysqli_query($bd, $sql);
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql1 = "select * from doctorSpecilization";
$sql=mysqli_query($bd, $sql1);
$cnt=1;
