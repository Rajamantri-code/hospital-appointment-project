...
{
	$sql1 = "update  doctorSpecilization set specilization='".$_POST['doctorspecilization']."', updationDate='$currentTime'where id='$id'";
...
$id=intval($_GET['id']);
$sql1 = "select * from doctorSpecilization where id='$id'";
	$sql=mysqli_query($bd, $sql1);
