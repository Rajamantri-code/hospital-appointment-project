...
$city=$_POST['city'];
$gender=$_POST['gender'];
$sql1 = "Update users set fullName='$fname',address='$address',city='$city',gender='$gender' where email='".$_SESSION['login']."'";
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php 
									$sql1 = "select * from users where email='".$_SESSION['login']."'";
									$sql=mysqli_query($bd, $sql1);
